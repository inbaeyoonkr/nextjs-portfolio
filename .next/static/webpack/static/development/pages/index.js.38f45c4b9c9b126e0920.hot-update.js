...
var Typewriter = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(function () {
...
var printMessages = function printMessages() {
  var messages, jsxArray, _loop, m;

  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.async(function printMessages$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          messages = INFO_MESSAGES.split('.');
          jsxArray = [];

          _loop = function _loop(m) {
            messages[m] += '.';
          ...
          for (m = 0; m < messages.length - 1; m++) {
            _loop(m);
          }

          return _context.abrupt("return", jsxArray);
...
var IndexBlock = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div(_templateObject());
var MessageBlock = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div(_templateObject2());
...
//# sourceMappingURL=index.js.38f45c4b9c9b126e0920.hot-update.js.map