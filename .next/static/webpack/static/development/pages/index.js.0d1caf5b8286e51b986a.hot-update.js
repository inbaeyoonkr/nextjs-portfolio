...
var printMessages = function printMessages() {
  ...
  var _loop = function _loop(_m) {
    messages[_m] += '.';
    console.log(messages[_m]);
    jsxArray.push(__jsx(Typewriter, {
      options: {
        cursor: ''
      },
      onInit: function onInit(typewriter) {
        typewriter.typeString(messages[_m]).callFunction(function () {
  ...
  for (var _m = 0; _m < messages.length - 1; _m++) {
    _loop(_m);
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function render() {
      return __jsx(IndexBlock, {
        ...
        __self: this
      }, printMessages(INFO_MESSAGES)), strings.forEach(function (item) {
        return task(item);
      }), __jsx(_components_DirectionButton__WEBPACK_IMPORTED_MODULE_9__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 85
        },
...
//# sourceMappingURL=index.js.0d1caf5b8286e51b986a.hot-update.js.map